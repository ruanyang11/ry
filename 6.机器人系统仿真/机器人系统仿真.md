# [第 6 章 机器人系统仿真](http://www.autolabor.com.cn/book/ROSTutorials/)
...
1.创建并显示机器人模型![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/17_xacro案例.PNG)![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/18_gazebo案例.PNG)

2.仿真环境搭建![img](https://gitee.com/ry2001/img1/raw/master/202507111902705.png)

3.控制机器人运动![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/arbotix运动控制.gif)![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/gazebo运动控制.gif)

4.雷达仿真

![img](https://gitee.com/ry2001/img1/raw/master/202507111902645.png)

5.摄像头仿真![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/rgb摄像头.PNG)![img](https://gitee.com/ry2001/img1/raw/master/202507111902005.png)
...
**结果演示:**![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/02_URDF文件执行rviz配置02.png)
...
rviz 启动后，会发现并没有盒装的机器人模型，这是因为默认情况下没有添加机器人显示组件，需要手动添加，添加方式如下:![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/01_URDF文件执行rviz配置01.png)![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/02_URDF文件执行rviz配置02.png)设置完毕后，可以正常显示了

#### 5.优化 rviz 启动

重复启动`launch`文件时，Rviz 之前的组件配置信息不会自动保存，需要重复执行步骤4的操作，为了方便使用，可以使用如下方式优化:

首先，将当前配置保存进`config`目录![img](https://gitee.com/ry2001/img1/raw/master/202507111903762.png)然后，`launch`文件中 Rviz 的启动配置添加参数:`args`,值设置为`-d 配置文件路径`
...
urdf 中的 link 标签用于描述机器人某个部件(也即刚体部分)的外观和物理属性，比如: 机器人底座、轮子、激光雷达、摄像头...每一个部件都对应一个 link, 在 link 标签内，可以设计该部件的形状、尺寸、颜色、惯性矩阵、碰撞参数等一系列属性![img](https://gitee.com/ry2001/img1/raw/master/202507111905017.png)
...
joint标签对应的数据在模型中是不可见的![img](https://gitee.com/ry2001/img1/raw/master/202507111906686.png)
...
**结果演示:**![img](https://gitee.com/ry2001/img1/raw/master/202507111908722.png)**实现流程:**
...
![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/03_URDF文件检查_正常.png)

![img](https://gitee.com/ry2001/img1/raw/master/202507111909142.png)

#### 2.urdf_to_graphiz 结构查看

进入urdf文件所属目录，调用:`urdf_to_graphiz urdf文件`，当前目录下会生成 pdf 文件

![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/05_查看URDF文件模型结构.png)
...
![img](https://gitee.com/ry2001/img1/raw/master/202507111911618.png)
...
![img](https://gitee.com/ry2001/img1/raw/master/202507111912234.png)
...
![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/arbotix运动控制.gif)
...
![img](https://gitee.com/ry2001/img1/raw/master/202507111913234.png)

**控制小车运动:**

此时调用 rostopic list 会发现一个熟悉的话题: /cmd_vel![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/07_arbotix实现02.png)也就说我们可以发布 cmd_vel 话题消息控制小陈运动了，该实现策略有多种，可以另行编写节点，或者更简单些可以直接通过如下命令发布消息:
...
**结果演示:**![img](https://gitee.com/ry2001/img1/raw/master/202507111918875.png)**实现流程:**
...
##### 1.1启动 Gazebo 并添加组件![img](https://gitee.com/ry2001/img1/raw/master/202508220843951.png)

##### 1.2保存仿真环境

添加完毕后，选择 file ---> Save World as 选择保存路径(功能包下: worlds 目录)，文件名自定义，后缀名设置为 .world![img](https://gitee.com/ry2001/img1/raw/master/202508220844910.png)
...
![img](https://gitee.com/ry2001/img1/raw/master/202508220844107.png)![img](https://gitee.com/ry2001/img1/raw/master/202508220844002.png)
...
可以像方式1一样再添加一些插件，然后保存为.world 文件(保存路径功能包下的: worlds),比如`hello.world`

![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/14_gazebo保存为world文件.png)
...
**<font color=red>注：如果更换了小车模型或者更换了工作空间，那么.world GZEBO环境需要重新搭建</font>**
...
接下来我们会发现: 小车在 Gazebo 中已经正常运行起来了![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/gazebo运动控制.gif)
...
执行 launch 文件后，在 Rviz 中添加图示组件:![img](https://gitee.com/ry2001/img1/raw/master/202507111921511.png)
...
先启动 rviz,添加雷达信息显示插件![img](https://gitee.com/ry2001/img1/raw/master/202507111923093.png)
...
执行 gazebo 并启动 Rviz,在 Rviz 中添加摄像头组件。![img](https://gitee.com/ry2001/img1/raw/master/202507111923177.png)![img](https://gitee.com/ry2001/img1/raw/master/202507111923147.png)
...
启动 rviz,添加摄像头组件查看数据![img](https://gitee.com/ry2001/img1/raw/master/202507111924573.png)![img](https://gitee.com/ry2001/img1/raw/master/202507111924640.png)
...
![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/点云数据_默认.PNG)
...
![img](http://www.autolabor.com.cn/book/ROSTutorials/assets/点云数据_修正.PNG)
